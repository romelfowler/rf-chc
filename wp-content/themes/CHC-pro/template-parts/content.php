...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	$image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()),'eightmedi-pro-archive-image');
	?>
	<figure>
	...
	<div class="entry-content">
		<?php echo eightmedi_pro_excerpt(get_the_excerpt(),300,'...',true,true);?>
