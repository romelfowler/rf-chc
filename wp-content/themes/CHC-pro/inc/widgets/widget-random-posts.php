 ...
 */
/**
 * Adds eightmedi_pro_random_posts widget.
 */
add_action('widgets_init', 'register_random_posts_widget');

function register_random_posts_widget() {
    register_widget('eightmedi_pro_register_random_posts');
}

class eightmedi_pro_register_random_posts extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'eightmedi_pro_register_random_posts', 'ED :  Random Posts', array(
                'description' => __( 'A widget that shows Random posts', 'eightmedi-pro' )
                )
            );
    }
    ...
    private function widget_fields() {
        $fields = array(
            'random_posts_title' => array(
                'eightmedi_pro_widgets_name' => 'random_posts_title',
