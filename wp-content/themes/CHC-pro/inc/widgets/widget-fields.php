 ...
 */
function eightmedi_pro_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    
    extract($widget_field);

    switch ($eightmedi_pro_widgets_field_type) {

        // Standard text field
        case 'text' :
        ?>
        <p>
            <label for="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>"><?php echo $eightmedi_pro_widgets_title; ?>:</label>
            <input class="widefat" id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" type="text" value="<?php echo esc_attr($athm_field_value) ; ?>" />

            <?php if (isset($eightmedi_pro_widgets_description)) { ?>
            <br />
            <small><?php echo $eightmedi_pro_widgets_description; ?></small>
            <?php } ?>
        </p>
        <?php
        break;
        ...
        <p>
            <label for="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>"><?php echo $eightmedi_pro_widgets_title; ?>:</label>
            <input class="widefat" id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />
        ...
        <p>
            <label for="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>"><?php echo $eightmedi_pro_widgets_title; ?>:</label>
            <textarea class="widefat" rows="<?php echo $eightmedi_pro_widgets_row; ?>" id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
        </p>
        <?php
        break;
        ...
        ?>
        <p>
            <input id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
            <label for="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>"><?php echo $eightmedi_pro_widgets_title; ?></label>
        ...
        <p>
            <?php
            echo $eightmedi_pro_widgets_title;
            echo '<br />';
            foreach ($eightmedi_pro_widgets_field_options as $athm_option_name => $athm_option_title) {
                ?>
                <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        // Select field
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>"><?php echo $eightmedi_pro_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" class="widefat">
                    <?php foreach ($eightmedi_pro_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
            ...
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>"><?php echo $eightmedi_pro_widgets_title; ?>:</label><br />
                <input name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
            ...
            <p>
                ...
                echo wp_dropdown_categories(
                    array(
                      'name'              => $instance->get_field_name($eightmedi_pro_widgets_name),
                      'echo'              => 0,
                      'show_option_none'  => __( '&mdash; Select &mdash;','eightmedi-pro' ),
                      'option_none_value' => '0',
                      'selected'          => $athm_field_value,
                      'id'                => $instance->get_field_id($eightmedi_pro_widgets_name),
                      'class'             =>'widefat'
                      )
                    );
                    ?>
                ...
                $output .= '<label for="'.$instance->get_field_id($eightmedi_pro_widgets_name).'">'.$eightmedi_pro_widgets_title.'</label><br/>';
                $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'eightmedi-pro') . '" />' . "\n";
                if (function_exists('wp_enqueue_media')) {
                    if (( $value == '')) {
                        $output .= '<input id="upload-' . $id . '" class="upload-button button" type="button" value="' . __('Upload', 'eightmedi-pro') . '" />' . "\n";
                    } else {
                        $output .= '<input id="remove-' . $id . '" class="remove-file button" type="button" value="' . __('Remove', 'eightmedi-pro') . '" />' . "\n";
                    }
                } else {
                    $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'eightmedi-pro') . '</i></p>';
                }
                ...
                if ($value != '') {
                    ...
                    $attachment_id = eightmedi_pro_get_attachment_id_from_url($value);
                    ...
                    // Standard generic output if it's not an image.
                        $title = __('View File', 'eightmedi-pro');
                ...
                <p>
                    ...
                    <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($eightmedi_pro_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($eightmedi_pro_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
        ...
        function eightmedi_pro_widgets_updated_field_value($widget_field, $new_field_value) {

            extract($widget_field);

    // Allow only integers in number fields
            if ($eightmedi_pro_widgets_field_type == 'number') {
                return absint($new_field_value);

        // Allow some tags in textareas
            } elseif ($eightmedi_pro_widgets_field_type == 'textarea') {
        // Check if field array specifed allowed tags
                if (!isset($eightmedi_pro_widgets_allowed_tags)) {
            // If not, fallback to default tags
                    $eightmedi_pro_widgets_allowed_tags = '<p><strong><em><a>';
                }

                return strip_tags($new_field_value, $eightmedi_pro_widgets_allowed_tags);

        // No allowed tags for all other fields
            } elseif ($eightmedi_pro_widgets_field_type == 'iframe_textarea') {
        // Check if field array specifed allowed tags
                if (!isset($eightmedi_pro_widgets_allowed_tags)) {
            // If not, fallback to default tags
                    $eightmedi_pro_widgets_allowed_tags = '<iframe>';
                }
        ...
        // No allowed tags for all other fields
            ...
            elseif ($eightmedi_pro_widgets_field_type == 'url') {
                return esc_url_raw($new_field_value);
            }
            elseif ($eightmedi_pro_widgets_field_type == 'title') {
...
function optionsframework_media_scriptss($hook) {
    ...
    wp_register_script('of-media-uploader', get_template_directory_uri(). '/inc/admin-panel/js/media-uploader.js', array('jquery'), 1.70);
    wp_enqueue_script('of-media-uploader');
    wp_localize_script('of-media-uploader', 'optionsframework_l10n', array(
        'upload' => __('Upload', 'eightmedi-pro'),
        'remove' => __('Remove', 'eightmedi-pro')
        ));
