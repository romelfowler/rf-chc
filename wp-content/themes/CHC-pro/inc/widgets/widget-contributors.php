 ...
 */
/**
 * Adds eightmedi_pro_contributors widget.
 */
add_action('widgets_init', 'article_contributors_widget');

function article_contributors_widget() {
    register_widget('eightmedi_pro_article_contributors');
}

class eightmedi_pro_article_contributors extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'eightmedi_pro_article_contributors', 'ED :  Article Contributors', array(
            'description' => __('A widget that shows article contributors', 'eightmedi-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            'contributors_title' => array(
                'eightmedi_pro_widgets_name' => 'contributors_title',
