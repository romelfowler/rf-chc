...
function register_preview_post_widget() {
	register_widget('eightmedi_pro_editor_pick');
}

class eightmedi_pro_Editor_Pick extends WP_Widget {
    ...
    public function __construct() {
    	parent::__construct(
    		'eightmedi_pro_editor_pick', 'ED : Category Posts', array(
    			'description' => __('A widget that shows posts of a category', 'eightmedi-pro')
    			)
    		);
    }
    		...
    		<div class="content-wrapper">
    			...
    			if($loop->have_posts()){
    				while($loop->have_posts()){
    					...
    					$editor_big_image_path = wp_get_attachment_image_src( $editor_image_id, 'eightmedi-pro-team-image', true );
    						...
    						<div class="post-image">
    							...
    							<div class="post-desc-wrapper">
    								...
    								<div class="block-poston">
    									<?php do_action('eightmedi_pro_home_posted_on');?>
    								</div>
