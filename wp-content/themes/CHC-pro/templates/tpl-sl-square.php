 ...
 * different template.
 *
 * Template Name: Service List Square
...
<div class="ed-container">
	...
	<header class="page-header">
		...
		echo __('Service List Square View','eightmedi-pro');
		echo '</h1>';
	...
	if($sidebar=='both-sidebar'){
		...
		<div id="primary" class="content-area <?php echo $sidebar;?>">
			...
			?>
			<main id="main" class="site-main service-block-wrapper <?php echo esc_attr($wrap_class);?>" role="main">

				<?php 
				$team_args      =   array('post_type'=>'service','post_status'=>'publish', 'posts_per_page'=>-1);
