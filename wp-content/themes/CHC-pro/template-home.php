				...
				<div class="ed-container-home">
					...
					<div class="featured-block<?php if($i%5==0){echo " nomargin";} echo ' featured-post-'.$i;?> wow fadeInLeft"  data-wow-delay="<?php echo $i*0.3;?>s">
						<div class="featured-text">
							...
							<div class="featured-content"><?php the_content(); ?></div>
							<!-- <p><?php // echo eightmedi_pro_excerpt(get_the_excerpt(),'250','...',true,true);?></p> -->
						</div>
					</div>
					<?php
					endwhile;
								...
								<div class="team-block<?php if($i%4==0){echo " nomargin";} ?>" >
									<a href="<?php the_permalink(); ?>">
										<figure class="team-image">
											...
											<img src="<?php echo esc_attr(get_template_directory_uri().'/images/fallback-person.jpg'); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" /> <?php
											endif;
											?>
				...
				if(get_theme_mod('eightmedi_pro_news_setting_option')=='enable'){
					...
					<section class="latest-news clear">
						<div class="ed-container-home">
							...
							<?php
							if(get_theme_mod('eightmedi_pro_news_button_option','enable')=='enable'){
